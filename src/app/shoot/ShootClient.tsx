      ...
      <section className="py-20 relative overflow-hidden bg-gradient-to-b from-[#121215] to-[#0A0A0C] border-b border-white/5">
        ...
        <div className="max-w-[1280px] mx-auto px-5 md:px-10 lg:px-16 relative z-10 text-center">
          <p className="font-mono-custom text-[11px] tracking-[0.25em] uppercase text-[#F59A57] font-bold mb-4">
            TEST OUR PRODUCTION QUALITY • ZERO RISK
          </p>
            ...
            <div className="bg-[#121215] border border-[#F59A57]/30 rounded-3xl p-8 md:p-14 relative overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.4)]">
              <div className="max-w-3xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                  <div className="bg-[#0A0A0C] border border-white/5 rounded-2xl p-6">
                    ...
                    <ul className="text-sm text-white/70 space-y-2.5">
                      <li className="flex items-center gap-2"><span className="text-[#F59A57]">✓</span> <strong className="text-white/90">1 Content Shoot</strong></li>
                      <li className="flex items-center gap-2"><span className="text-[#F59A57]">✓</span> <strong className="text-white/90">Strategy + Scripting</strong></li>
                      <li className="flex items-center gap-2"><span className="text-[#F59A57]">✓</span> <strong className="text-white/90">15 Edited Reels</strong></li>
                      <li className="flex items-center gap-2"><span className="text-[#F59A57]">✓</span> <strong className="text-white/90">Ready-to-Post Content</strong></li>
                    </ul>
                  </div>
                  <div className="bg-[#0A0A0C] border border-white/5 rounded-2xl p-6">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <span className="text-white/40 text-xs font-mono">15 Reels • Complete Production • No Long-Term Commitment</span>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="bg-[#121215] border border-[#249E98]/30 rounded-3xl p-8 md:p-14 relative overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.4)]">
              <div className="max-w-3xl">
                <span className="inline-block font-mono-custom text-[10px] font-extrabold tracking-widest text-[#249E98] bg-[#249E98]/10 px-3.5 py-1.5 rounded-md uppercase mb-6">
                  OPTION 02 • FOR CREATORS &amp; INFLUENCERS
                </span>
                <h2 className="font-display font-extrabold text-white text-3xl md:text-4xl mb-6 leading-tight">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                  <div className="bg-[#0A0A0C] border border-white/5 rounded-2xl p-6">
                    <h3 className="font-bold text-white text-base mb-4">WHAT&apos;S INCLUDED</h3>
                    <ul className="text-sm text-white/70 space-y-2.5">
                      <li className="flex items-center gap-2"><span className="text-[#249E98]">✓</span> <strong className="text-white/90">1 Content Shoot</strong></li>
                      <li className="flex items-center gap-2"><span className="text-[#249E98]">✓</span> <strong className="text-white/90">Strategy + Scripting</strong></li>
                      ...
                      <li className="flex items-center gap-2"><span className="text-[#249E98]">✓</span> <strong className="text-white/90">Ready-to-Post Content</strong></li>
                    </ul>
                  </div>
                  <div className="bg-[#0A0A0C] border border-white/5 rounded-2xl p-6">
                    <h3 className="font-bold text-white text-base mb-3">WHY TAKE THE TRIAL?</h3>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <span className="text-white/40 text-xs font-mono">Strategy • Shoot • 10 Final Reels • No Long-Term Commitment</span>
                </div>
              </div>
            </div>
          )}
