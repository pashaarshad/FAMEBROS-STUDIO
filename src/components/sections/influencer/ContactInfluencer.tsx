...
export default function ContactInfluencer() {
      ...
      <div className="max-w-[640px] mx-auto px-5">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-[#55555A] text-sm md:text-base max-w-md mx-auto leading-relaxed">
            Connect directly on WhatsApp for an instant response, or drop your channel details in the quick form below.
          </p>
        </div>
          ...
          {!isSubmitted ? (
            <div className="space-y-8">
              ...
              <div className="bg-[#25D366]/5 border border-[#25D366]/20 rounded-2xl p-5 text-center flex flex-col items-center">
                ...
                <a 
                  href="https://wa.me/919892384424?text=Hi%2C%20I%20visited%20your%20website.%20I%20want%20to%20grow%20my%20brand.%20Please%20contact%20me%20back." 
                  target="_blank" 
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs text-[#55555A] font-semibold mb-2">Instagram / Channel Handle</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="block text-xs text-[#55555A] font-semibold mb-2">Content Niche</label>
                    <select
                ...
                <div>
                  ...
                  <textarea 
                    placeholder="Briefly describe your channel goals or content challenge"
              ...
              <div className="flex flex-col gap-3 max-w-xs mx-auto pt-4">
                ...
                <button 
                  onClick={() => {
                    ...
                    setFormData({ name: "", phone: "", socialHandle: "", category: "", message: "" });
                  }}
