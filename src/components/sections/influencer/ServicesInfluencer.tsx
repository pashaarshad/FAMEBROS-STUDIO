...
const services = [
  {
    ...
    desc: "Consistency is key. We create, schedule & manage content that converts.",
    img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=400&q=80",
  },
  {
    num: "02",
    title: "High-Quality Production",
    desc: "Stunning cinematic quality reels. Concept to post-production done for you.",
...
export default function ServicesInfluencer() {
  return (
