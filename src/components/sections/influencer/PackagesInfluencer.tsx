...
export default function PackagesInfluencer() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2.2fr] gap-12 items-start">
          ...
          <div>
            ...
            <div className="mt-10 max-w-[320px] hidden lg:block relative select-none pointer-events-none">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(245,154,87,0.14),transparent_70%)] z-0 blur-xl" />
