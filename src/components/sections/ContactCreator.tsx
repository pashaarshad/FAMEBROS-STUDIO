            ...
            <div className="space-y-8">
              ...
              <div className="bg-[#25D366]/5 border border-[#25D366]/20 rounded-2xl p-5 text-center flex flex-col items-center">
                ...
                <h3 className="font-display font-bold text-[#0A0A0A] text-[15px] mb-3">
                  Start a conversation with our team on WhatsApp
                </h3>
                
                <a 
                  href="https://wa.me/919892384424?text=Hi%2C%20I%20visited%20your%20website.%20I%20want%20to%20grow%20my%20creator%20brand.%20Please%20contact%20me%20back." 
                  target="_blank" 
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-white border border-black/10 rounded-xl p-3 text-[#0A0A0A] text-sm focus:border-[#249E98] focus:outline-none transition-all placeholder:text-gray-400"
                      required
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs text-[#55555A] font-semibold mb-2">Instagram / Social Media Handle*</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="block text-xs text-[#55555A] font-semibold mb-2">Your Location*</label>
                    <input 
                      type="text" 
                ...
                <div>
                  ...
                  <textarea 
                    placeholder="Briefly tell us what you want to grow or improve."
                    value={formData.message}
                    onChange={(e) => setFormData({ ...formData, message: e.target.value })}
                    rows={3}
                    className="w-full bg-white border border-black/10 rounded-xl p-3 text-[#0A0A0A] text-sm focus:border-[#249E98] focus:outline-none transition-all resize-none placeholder:text-gray-400"
                    suppressHydrationWarning
                  />
                </div>
              ...
              <div className="flex flex-col gap-3 max-w-xs mx-auto pt-4">
                ...
                <button 
                  onClick={() => {
                    ...
                    setFormData({ name: "", phone: "", handle: "", location: "", message: "" });
                  }}
