    ...
    <section id="founder" className="bg-[#050505] py-24 border-t border-white/5 relative overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-5 md:px-10 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_2.1fr] gap-12 lg:gap-16 items-center mb-16">
          ...
          {/* Right Column - Horizontal Cards with responsive photo containers */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="bg-[#111416]/40 border border-[#F59A57]/20 rounded-2xl flex flex-row items-stretch hover:border-[#F59A57]/40 transition-all duration-300 relative overflow-hidden group min-h-[220px]">
              ...
              {/* Left Cutout Photo - touching absolute bottom-left edge, responsive width */}
              ...
              {/* Right Profile Details - responsive padding */}
              <div className="flex-1 py-4 pr-4 pl-2 md:py-6 md:pr-6 md:pl-4 flex flex-col justify-center relative z-20">
                {/* Custom styled signature image with orange filter tint, responsive height */}
                ...
                <h3 className="font-display font-extrabold text-[14px] md:text-[16px] text-white tracking-wider uppercase mb-0.5">
                  Sultan Yunus
                </h3>
                ...
                <div className="flex gap-2">
                  <a 
                    ...
                    className="w-7 h-7 md:w-8 md:h-8 rounded-full border border-[#F59A57]/30 hover:border-[#F59A57] flex items-center justify-center text-white/70 hover:text-white transition-all bg-black/30"
                  >
            ...
            <div className="bg-[#111416]/40 border border-[#249E98]/20 rounded-2xl flex flex-row items-stretch hover:border-[#249E98]/40 transition-all duration-300 relative overflow-hidden group min-h-[220px]">
              ...
              {/* Right Profile Details - responsive padding */}
              <div className="flex-1 py-4 pr-4 pl-2 md:py-6 md:pr-6 md:pl-4 flex flex-col justify-center relative z-20">
                {/* Custom styled signature image with teal filter tint, responsive height */}
                <div className="h-8 md:h-10 mb-1.5 relative select-none">
                  <img 
                    src="/Sultan sign.png" 
                    alt="Sultan Yunus Signature"
                ...
                <div className="flex gap-2">
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-7 h-7 md:w-8 md:h-8 rounded-full border border-[#249E98]/30 hover:border-[#249E98] flex items-center justify-center text-white/70 hover:text-white transition-all bg-black/30"
                  >
                    <svg className="w-3.5 h-3.5 md:w-4 md:h-4" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.051.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z" />
                    </svg>
